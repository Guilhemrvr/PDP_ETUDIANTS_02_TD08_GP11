...
const char* wifi_ssid = "iPhone de Guillaume";
const char* wifi_password = "gui291001";
...
const char* client_id = "TD02_GP11";

#define TEMP "TD08_GP11/temp"
#define HUM "TD08_GP11/relhum"
...
void setup() {
  ...
  if(mqtt_client.connect(client_id,mqtt_user,mqtt_pass))
  {
    ...
    mqtt_client.publish(HUM, String(temp_measure).c_str());
  }
